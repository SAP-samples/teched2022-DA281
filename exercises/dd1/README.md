...
We now continue to [Deep Dive 2 - Creating a Custom ABAP Operator and making use of it in an SAP Data Intelligence Pipeline](../dd2/README.md)
...
- [Overview and Getting Started](../ex0/README.md#overview-and-getting-started)
  - [Deep Dive demos vs. Exercises](../ex0/README.md#deep-dive-vs-exercise-sections-in-this-document)
  - [Short introduction to the Enterprise Procurement Model (EPM) in ABAP systems](../ex0/README.md#short-introduction-to-the-enterprise-procurement-model-epm-in-sap-s4hana)
  - Access to the exercises' Data Intelligence environment (**will be provided after the session**)
- [Deep Dive 1 - ABAP CDS View based data extraction in SAP Data Intelligence](../dd1/README.md#deep-dive-1---abap-cds-view-based-data-extraction-in-sap-data-intelligence)
- [Deep Dive 2 - Creating a Custom ABAP Operator and making use of it in an SAP Data Intelligence Pipeline](../dd2/README.md)
- [Deep Dive 3- Technical Background for Replication Flows in SAP Data Intelligence](../dd3/README.md)
- [Overview and Getting Started](../ex0/README.md#overview-and-getting-started)
...
- [Exercise 2 - Triggering the execution of a function module in a remote S/4HANA system](../ex2/)
    - [Exercise 2.1 - Making custom ABAP Operators available in SAP Data Intelligence](../ex2#exercise-21-sub-exercise-1-description)
    - [Exercise 2.2 - Using a custom ABAP Operator to verify your Delta Replication of EPM Sales Orders](../ex2#exercise-22-sub-exercise-2-description)

- [Exercise 3 - Integrate ABAP CDS Views in SAP Data Intelligence Replication Management Flow](../ex3/README.md#exercise-3---integrate-abap-cds-views-in-sap-data-intelligence-replication-management-flow)
